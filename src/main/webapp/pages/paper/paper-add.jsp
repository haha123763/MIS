...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/paper/save.do" method="post"
					...
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="论文编号" name="id" value="" required="required">
							</div>
							<div class="col-md-2 title">论文标题</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="论文标题" name="title" value="" required="required">
							</div>
							<div class="col-md-2 title">作者列表</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="作者列表" name="authors"  value="">
							</div>
							<div class="col-md-2 title">刊物(会议)名称</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="刊物(会议)名称" name="pc_name" value="">
							</div>

							<div class="col-md-2 title">年份</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="年份" name="year" value="">
							</div>
							...
							<div class="col-md-4 data">
								<select class="form-control select2" name="inclusion" style="width: 100%;">
                                    <option value=""></option>
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="影响因子" name="impact" value="">
							</div>
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="卷" name="volume">
							</div>
							<div class="col-md-2 title">期</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="期" name="issue">
							</div>
							...
							<span style="color: #aa1111;letter-spacing: 1px;"  id="fileAlert"></span>
						</div>
		...
		function checkForm(form){
			if(!form.file.value == "")
			{
				if(!form.file.value.endsWith(".pdf")) {
					$('#fileAlert').html("上传文件的类型不匹配,请选择PDF文件");
					$('#file').focus();
					$("#file").val("");
					return false;
				}
