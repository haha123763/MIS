		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">横向项目添加</li>
				</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/project/save_t.do" enctype="multipart/form-data" method="post">
				<!-- 正文区域 -->
				<section class="content">
					<div class="panel panel-default">
						<div class="panel-heading">横向项目信息</div>
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="category" value="横向" readonly="readonly">
							</div>

							<div class="col-md-2 title">课题来源</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="source" placeholder="项目委托方名称">
							</div>
							...
							<div class="col-md-4 data">
								<input type="text"  class="form-control" name="receivedFund">
							</div>
