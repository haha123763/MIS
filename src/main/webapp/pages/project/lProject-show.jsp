				...
				<section class="content">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-2 title" id="level1">课题级别</div>
							<div class="col-md-4 data" id="level2">${project.level}</div>
							<div class="col-md-2 title" >课题来源</div>
							<div class="col-md-4 data">${project.source}</div>
							<div class="col-md-2 title" id="type1">课题类型</div>
							<div class="col-md-4 data" id="type2">${project.type}</div>
