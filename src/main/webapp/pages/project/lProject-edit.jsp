			...
			<section class="content">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control"  name="number"  required="required" value="${project.number}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" name="level" style="width: 100%;">
								<option value="${project.level}" selected="selected">${project.level}</option>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" name="source" style="width: 100%;">
								<option value="${project.source}" selected="selected">${project.source}</option>
