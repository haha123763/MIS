...
<meta
	...
	name="viewport">
	<jsp:include page="../link.jsp"></jsp:include></head>
                                ...
                                <form class="form-inline" action="${pageContext.request.contextPath}/paper/selectByTerms.do" method="post">
									<div class="row data-type">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="authors" name="authors" value="${condition.authors[0]}">
										</div>
										<div class="form-group">
											<label for="title">标题</label>
											<input type="text" class="form-control" id="title" name="title" value="${condition.title[0]}">
										</div>
										<div class="form-group">
											<label for="year">年份</label>
											<input type="text" class="form-control" id="year" name="year" value="${condition.year[0]}">
										</div>
										<div class="form-group">
											<label for="category">论著类别</label>
										...
										<div class="form-group">
											<label for="inclusion">收录情况</label>
											<select class="form-control" name="inclusion" id="inclusion">
												<option value="${condition.inclusion[0]}" selected="selected">${condition.inclusion[0]}</option>
												<option value=""></option>
										...
										<div class="form-group">
											<label for="inclusion">SCI分区</label>
											<select class="form-control" name="sci" id="sci" >
												<option value="${condition.sci[0]}" selected="selected">${condition.sci[0]}</option>
												<option value=""></option>
									...
									<c:forEach items="${pageInfo.list}" var="paper">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/paper/deleteById.do?id=${paper.id}" class="btn bg-olive btn-xs" onclick="return confirm('你确认要删除吗？')">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
